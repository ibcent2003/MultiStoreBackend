...
namespace Project.UI.Models
{
    public class ProcessUtility
    {
        ...
        public static string GetSHA512Crypt(string text)
        {
        ...
        #region Number To Word Functions
        ...
        public void RemoveAllAddedObjects(ObjectContext context)
        {
        ...
        {
            string ExMessage ="Error occured. Please try again later";
        ...
        public List<DateTime> GetAllDatesInRange(DateTime StartDate, DateTime EndDate)
        {
